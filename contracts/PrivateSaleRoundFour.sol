...
contract PrivateSaleRoundFour is Policy {
    ...
    function toggleWhitelisted(address _address) external onlyPolicy {
    ...
    function deposit(
        ...
        require(totalDebt <= terms.maxDebt, "Max Capacity has reached");
    ...
    function redeem(address _recipient) external returns (uint256) {
        ...
        if (percentVested >= 10000) {
            ...
            // note redeem first time
            // bug chưa đến thời gian vesting, block.timestamp < lastBlock
            ...
            bondInfo[_recipient] = PriSale({
                ...
                amountClaim: 0,
                // if after cliffing and before vesting, payout is 0
